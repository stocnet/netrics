...
question("Why are lattices considered highly clustered?",
         answer("Because neighbours are likely also neighbours of each other",
                message = paste0(learnr::random_praise(),
                                 ' <br><br> <img src="https://media.tenor.com/images/e26e64a8cce94a6ee491f0ddeecc8b88/tenor.gif"/>'),
                correct = TRUE),
...
<span class="page-toc-link" onclick="document.getElementById('section-weighted-cores').scrollIntoView({behavior:'auto',block:'start'});">Weighted</span> ·
<span class="page-toc-link" onclick="document.getElementById('section-directed-cores').scrollIntoView({behavior:'auto',block:'start'});">Directed</span> ·
...
::: {.callout}
<span class="callout-label">**In brief**:</span> On a weighted network,
...
::: {.callout}
<span class="callout-label">**In brief**:</span> `create_core()` draws the ideal core-periphery network; 
...
| `coreness_richcore()`, `coreness_correlation()` | the methods behind those functions; `coreness_richcore()` reads weights and direction |
